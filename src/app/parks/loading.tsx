import { skeletonDaylight } from "@/components/ui/styles";
    ...
    <div className="divide-y divide-forest-ink/12 border-y border-forest-ink/12">
      {[1, 2, 3].map((i) => (
        <div key={i} className="py-6" aria-hidden="true">
          <div className={`mb-3 h-6 w-48 ${skeletonDaylight}`} />
          <div className={`mb-2 h-4 w-32 ${skeletonDaylight}`} />
          <div className={`mb-2 h-4 w-full ${skeletonDaylight}`} />
